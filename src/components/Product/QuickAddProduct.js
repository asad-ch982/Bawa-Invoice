...
function QuickAddProduct() {
  ...
  const submitHandler = useCallback(() => {
    ...
    dispatch(addNewProduct({ ...productForm, slug: nanoid() }));
    setIsTouched(false);
          ...
          <div className="flex-1">
            {isInitLoading ? (
              ...
              <input
                ...
                type="text"
                className={
                  !validForm.variant && isTouched
                    ? defaultInputInvalidStyle
                    : defaultInputStyle
                }
                disabled={isInitLoading}
                value={productForm.variant}
                onChange={(e) => handlerProductValue(e, "variant")}
              />
            )}
          </div>
        </div>
          ...
          <div className="flex-1">
            {isInitLoading ? (
              ...
              <input
                ...
                type="text"
                className={
                  !validForm.color && isTouched
                    ? defaultInputInvalidStyle
                    : defaultInputStyle
                }
                disabled={isInitLoading}
                value={productForm.color}
                onChange={(e) => handlerProductValue(e, "color")}
              />
            )}
          </div>
        </div>
          ...
          <div className="flex-1">
            {isInitLoading ? (
              ...
              <input
                ...
                type="number"
                className={
                  !validForm.wholeSalePrice && isTouched
                    ? defaultInputInvalidStyle
                    : defaultInputStyle
                }
                disabled={isInitLoading}
                value={productForm.wholeSalePrice}
                onChange={(e) => handlerProductValue(e, "wholeSalePrice")}
              />
            )}
          </div>
        </div>
          ...
          <div className="flex-1">
            {isInitLoading ? (
              ...
              <input
                ...
                type="text"
                className={
                  !validForm.company && isTouched
                    ? defaultInputInvalidStyle
                    : defaultInputStyle
                }
                disabled={isInitLoading}
                value={productForm.company}
                onChange={(e) => handlerProductValue(e, "company")}
              />
            )}
          </div>
        </div>
          ...
          <div className="flex-1">
            {isInitLoading ? (
              ...
              <input
                ...
                type="text"
                className={
                  !validForm.desc && isTouched
                    ? defaultInputInvalidStyle
                    : defaultInputStyle
                }
                disabled={isInitLoading}
                value={productForm.desc}
                onChange={(e) => handlerProductValue(e, "desc")}
              />
            )}
          </div>
        </div>
